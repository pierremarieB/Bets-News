...
d3.wordcloud()
        .size([600, 400])
        .selector('#homeWordcloud')
        .words(test)
        .start();


function cleanTokens(words) {
  var trashTokens = ["les","avec","C'est","dans","avait","avoir","est","été","cette","d'une","dont","que","son","qui","une","pas","ses","lors","sur","lui","c'est","des","la","le","de la","à la","qu'il","sur le","leurs","faire","avoir","qu'on","et la","et le","par","pour"];
  var res = [];
